...
Of course, as a framework, ``gingerprawn`` requires wxPython. The version must
be *at least 2.8*, and *the Unicode version is needed*. You can get wxPython
at its official website <http://www.wxpython.org/>.
...
or Emacs or whatever editor you use.
...
keep stable at the moment. If you feel like to contribute, contact the author:
    ...
    Wang Xuerui (xenon@JNRain) <idontknw.wang@gmail.com>
